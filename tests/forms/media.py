...
from iktomi.forms.widgets import Widget, FieldBlock
            ...
            fields=[
                FieldBlock('', [
                    Field('name',
                          widget=Widget(media=FormCSSRef('field.css'))),
                    Field('name1',
                          widget=Widget(media=FormCSSRef('field1.css')))],
                    media=FormCSSRef('block.css'))]
        form = F()
        self.assertEqual(form.get_media(), 
                         FormMedia(items=[FormCSSRef('block.css'),
                                          FormCSSRef('field.css'),
                                          FormCSSRef('field1.css')]))
